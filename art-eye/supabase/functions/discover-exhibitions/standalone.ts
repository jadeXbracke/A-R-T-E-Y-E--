...
//
// STANDALONE COPY: this is the same function as index.ts but with the shared
// helpers inlined, so you can paste it as a single file into the Supabase
// dashboard Edge Function editor (no separate _shared file needed).
