-- ART EYE — ALL-IN-ONE database setup (paste this whole file into the
-- Supabase SQL Editor and press Run). Safe to run once on a fresh project.
-- Contains: every migration (0001–0015) in order + the 54 real Sydney venues.
-- Generated from supabase/migrations/*.sql + supabase/venues_seed.sql
...
-- ============================================================
-- migrations/0006_pipeline_cron.sql
-- ============================================================
