// Sleep as a circle: each of the last seven nights drawn as an arc on the
// same 24-hour dial the app already uses for time (midnight at the top),
// stacked as concentric rings — newest outermost and darkest, older nights
// fading inward. Tightly aligned arcs read as a steady rhythm; scattered
// ones read as a ragged week. No ticks, no numbers on the dial itself.
    ...
    <View style={{ width: size, height: size, alignItems: 'center', justifyContent: 'center' }}>
      <Svg width={size} height={size} style={{ position: 'absolute' }}>
        ...
        {last.map((n, i) => {
          ...
          const opacity = scheme === 'dark' ? 1 - age * 0.12 : 1 - age * 0.13;
          return (
            <Path
              key={n.id}
